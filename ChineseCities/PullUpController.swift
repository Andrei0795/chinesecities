...
extension UIViewController {
    ...
    open func addPullUpController(_ pullUpController: PullUpController) {
        ...
        var customSize: CGSize = view.frame.size
        customSize.height = customSize.height - 50 //This is for the beginning when the  search is hidden. people will know what it is and then use it
        pullUpController.refreshConstraints(size: customSize)
    }
}
